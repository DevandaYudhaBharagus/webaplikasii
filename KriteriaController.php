...
class KriteriaController extends BaseController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->orderby)){
			...
			$db->orderBy("kriteria.id", ORDER_TYPE);
		}
		if($fieldname){
		...
		$this->render_view("kriteria/list.php", $data); //render the full page
	}
	/**
     * View record detail 
	...
	function view($rec_id = null, $value = null){
		...
		if($value){
			...
			$db->where("kriteria.id", $rec_id);; //select record based on primary key
		}
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("sub_kriteria");
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'sub_kriteria' => 'required',
			);
			$this->sanitize_array = array(
				'sub_kriteria' => 'sanitize_string',
			);
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","sub_kriteria");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'sub_kriteria' => 'required',
	...
	function delete($rec_id = null){
		...
		$db->where("kriteria.id", $arr_rec_id, "in");
